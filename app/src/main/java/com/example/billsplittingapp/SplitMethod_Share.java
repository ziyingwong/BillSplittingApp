...
public class SplitMethod_Share extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.method_share);
        final Toolbar toolbar = findViewById(R.id.toolbarshare);
        ...
        recyclerView2 = findViewById(R.id.sharevaluelist);
        adapter = new MethodSplitAdapterShare(arrayList,total);
        recyclerView2.setLayoutManager(new LinearLayoutManager(this));
        recyclerView2.setAdapter(adapter);

        buttonShareconfirmed = findViewById(R.id.buttonShareconfirmed);
        buttonShareconfirmed.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                for (int i = 0; i < userArray.size(); i++) {
                    ...
                    EditText amount = view.findViewById(R.id.etshare);
                ...
                if(emptycheck == false){
                    ...
                    for (int i = 0; i < userArray.size(); i++) {
                        ...
                        Double newportion = (portion/counttotal)*total;
                    ...
                    Intent intent = new Intent(SplitMethod_Share.this, ExpenseAddNew.class);
